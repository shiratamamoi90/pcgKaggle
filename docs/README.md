...
| **[WRITEUP-EN.md](WRITEUP-EN.md)** | 同レポートの英語版（本文1,577語＝2,000語制限内。見出しを含めて1,648語、表まで含めると2,012語、タイトルまで含めると2,044語）。**提出しない参考訳**。日本語版にある三すくみとチェックリストは削ってある。2026-09-12 に日本語版と同じ書式規則（太字・バッククォート・引用ブロック・斜体を使わない、1段落1行、略語は初出で定義）へ揃えた |
